...
all_links = browser.find_by_css('a.product-item h3')[2].click()


# In[67]:


full_image_page = browser.find_by_text('Sample')[0]
full_image_url = full_image_page['href']
image_title = browser.find_by_css('h2.title').text
image_title
...
all_links = browser.find_by_css('a.itemLink h3')[0].click()


# In[55]:


full_image_page = browser.find_by_text('Sample')[0].click()
